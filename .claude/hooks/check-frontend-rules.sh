...
if [ "$VIOLATIONS" -gt 0 ]; then
  hook_report ""
  hook_report "Tishreen frontend rules: $VIOLATIONS violation(s) in $FILE. Fix them now (see tishreen-handoff/tishreen-handoff/docs/08-design-system.md and tishreen-handoff/tishreen-handoff/docs/10-i18n.md)."
  exit 2
fi
exit 0
